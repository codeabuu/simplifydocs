        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center py-24">
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
              <Link
                to="/signup" // Redirect to the Signup page
                className="px-8 py-4 gradient-bg text-white rounded-lg hover:opacity-90 transition-all duration-300 transform hover:scale-105 flex items-center justify-center group"
              >
